window.ChhLanguage = {
  'default': {
    ...
    'historian': {
      ...
      gridtxt3: 'Vert+Hori. Linien',
      gridtxt4: 'Vertikale Linien+',
      gridtxt5: 'Horizontale Linien+',
      gridtxt6: 'Vert+Hori. Linien+',
      contenttxt0: 'alles ausblenden',
      contenttxt1: 'Filter und Menü',
      contenttxt2: 'nur Filter Felder',
      contenttxt3: 'nur Historian-Menü',
      crosshairtxt0:  'ohne',
      crosshairtxt1:  'vert. 1px, nächster Punkt',
      crosshairtxt2:  'hori. 1px, nächster Punkt',
      crosshairtxt3:  'h/v.  1px, nächster Punkt',
      crosshairtxt4:  'vert. 1px, Mauszeiger',
      crosshairtxt5:  'hori. 1px, Mauszeiger',
      crosshairtxt6:  'h/v.  1px, Mauszeiger',
      crosshairtxt7:  'vert. 3px, nächster Punkt',
      crosshairtxt8:  'hori. 3px, nächster Punkt',
      crosshairtxt9:  'h/v.  3px, nächster Punkt',
      crosshairtxt10: 'vert. 3px, Mauszeiger',
      crosshairtxt11: 'hori. 3px, Mauszeiger',
      crosshairtxt12: 'h/v.  3px, Mauszeiger',
      tooltiptxt0:  'ohne Tooltips',
      tooltiptxt1:  'alle Tooltips',
      tooltiptxt2:  'einzeln',
      tooltiptxt3:  'kompakt alle',
      tooltiptxt4:  'kompakt einzeln',
      tooltiptxt5:  'kompakt gemeinsam',
      highlighttxt0:  'kein HighLighting',
      highlighttxt1:  'active +1px, inactive 0.2',
      highlighttxt2:  'active +1px, inactive 0.5',
      highlighttxt3:  'active +1px',
      highlighttxt4:  'active +3px, inactive 0.2',
      highlighttxt5:  'active +3px, inactive 0.5',
      highlighttxt6:  'active +3px',
      themenone: 'Standard',
      range30M: '30M',
      rangeH: 'H',
      range6H: '6H',
